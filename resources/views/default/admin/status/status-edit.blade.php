@inject('editStatusForm','Erp\Forms\StatusForm')
                ...
                <div class="student-box-header">
                    ...
                    <div class="col-md-6 col-xs-6 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active"> {{ trans('sidebar.edit_status') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 snt form-horizontal">
                    ...
                    {!! Form::model(
                        $statusToEdit,
                        array(
                            'route' => ['edit-status',$statusToEdit->id],
                            'files' => true,
                            'id'=>'create-form',
                            'class'=>'form-create',
                            'method'=>'PATCH'
                    ...
                    {!! formFields($editStatusForm,$mode='edit',$statusToEdit->id)  !!}
