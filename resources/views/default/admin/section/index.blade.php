                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @if(isset($sectionList) && !$sectionList->isEmpty())
                                            ...
                                            @foreach($sectionList as $section)
                                                <tr>
                                                    <td>{{ $sl++ }}</td>
                                                    <td>{{ $section->section_name or 'Not Available' }}</td>
                                                    <td>{{ $section->merit_level or 'Not Available' }}</td>
                                                    <td>{{ $section->studentClass->class_name or 'Not Available' }}</td>
                                                    ...
                                                    <td>{{ $section->status or 'Not Available' }}</td>
                                                    <td>
