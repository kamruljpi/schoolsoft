            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.guardian_edit') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.guardian_edit') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 snt form-horizontal">
                    ...
                    {!! Form::model(
                                $guardianProfile,
                                array(
                                'route' => ['guardian-edit',$guardianProfile->id],
                                'files' => true,
                                'id'=>'create-form',
                                'class'=>'form-create',
                                'method'=>'PATCH'
                    ...
                    {!! formFields($editGuardian,$mode='edit',$guardianProfile->id)  !!}
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var userId = "<?php echo $guardianProfile->id; ?> "
