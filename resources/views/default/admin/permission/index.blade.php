                                ...
                                <div class="box-body auto_scroll">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('sidebar.permission_name') }}</th>
                                        ...
                                        @foreach($model as $permission)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-info btn-xs mrg" data-original-title="{{ trans('translate.view') }}" data-toggle="tooltip" href="{{ route('permission-view',[$permission->id]) }}"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-success btn-xs mrg" data-original-title="{{ trans('translate.edit') }}" data-toggle="tooltip" href="{{ route('permission-edit-form',[$permission->id]) }}"><i class="fa fa-edit"></i></a>
                                                    <a  class="btn btn-danger btn-xs delete_btn mrg" data-original-title="{{ trans('translate.delete') }}" data-toggle="tooltip" href="{{ route('permission-delete',[$permission->id]) }}"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
