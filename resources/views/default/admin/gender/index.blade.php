                                ...
                                <div class="box-body auto_scroll">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped table-responsive">
                                        ...
                                        @foreach($model as $gender)
                                            <tr>
                                                <td>{{ $sl++ }}</td>
                                                <td>{{ $gender->gender_name or 'Null' }}</td>
                                                <td>{{ $gender->status or 'Null' }}</td>
                                                <td class="text-center">
                                                    ...
                                                    <a  class="btn btn-danger btn-xs delete_btn mrg" data-original-title="{{ trans('translate.delete') }}" data-toggle="tooltip" href="{{ route('gender-delete',[$gender->id]) }}"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
