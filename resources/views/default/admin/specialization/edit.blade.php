    ...
    <div class="row">
        <div class="col-md-12">
            <div class="student-box-header">
                <div class="col-md-6">
                    <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.specialization_edit') }}
                </div>
                <div class="col-md-6 snt">
                    <ul class="breadcrumb text-right">
                        ...
                        <li class="active">{{ trans('sidebar.specialization_edit') }}</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 snt form-horizontal">
                ...
                <div class="custom_row">
                    ...
                    <div class="custom_row">                      
                        <h2 class="form_title">
                            {{ trans('sidebar.specialization_edit') }}
                        </h2>                                          
                    </div>
                ...
                $specializationData,
                array(
                'route' => ['specialization-edit',$specializationData->id],
                'files' => true,
                'id'=>'create-form',
                'class'=>'form-create',
                'method'=>'PATCH'
                ...
                {!! formFields($editSpecialization,$mode='edit',$specializationData->id)  !!}
