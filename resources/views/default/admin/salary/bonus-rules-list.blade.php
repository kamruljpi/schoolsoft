            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.bonus_rule_list') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            <li>
                                <a href="{!! route('bonus-rules-create-form') !!}"><i class="fa fa-plus"></i> {{ trans('sidebar.bonus-rules-create') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body auto_scroll">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @if(isset($bonusRuleList) && !$bonusRuleList->isEmpty())
                                            @foreach($bonusRuleList as $bonusRule)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $bonusRule->name or 'Not Available'}}</td>

                                                    <td>{{ $bonusRule->status or 'Not Available'}}</td>


                                                    <td>

                                                        <a class="btn btn-primary btn-xs mrg" data-original-title="{{ trans('translate.view') }}" data-toggle="tooltip" href="{{ route('bonus-rule-view',[$bonusRule->id]) }}">
                                        ...
                                        <div class="pagination">{!!   str_replace('/?','?',$bonusRuleList->render() ) !!} </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
                    </div> <!--row last-->
