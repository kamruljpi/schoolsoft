            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.salary_cut_rules_list') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            <li>
                                <a href="{!! route('cut-rules-create-form') !!}"><i class="fa fa-plus"></i> {{ trans('sidebar.salarycut-rules-create') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body auto_scroll">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @if(isset($salaryCutRuleList) && !$salaryCutRuleList->isEmpty())
                                            @foreach($salaryCutRuleList as $salaryCutRule)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $salaryCutRule->name or 'Not Available'}}</td>

                                                    <td>{{ $salaryCutRule->status or 'Not Available'}}</td>


                                                    <td>

                                                        <a class="btn btn-primary btn-xs mrg" data-original-title="{{ trans('translate.view') }}" data-toggle="tooltip" href="{{ route('salary-cut-rule-view',[$salaryCutRule->id]) }}">
                                        ...
                                        <div class="pagination">{!!   str_replace('/?','?',$salaryCutRuleList->render() ) !!} </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
                    </div> <!--row last-->
