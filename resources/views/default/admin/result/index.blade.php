            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-6">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.result_sy_list') }}
                    </div>
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                            {{ trans('sidebar.result_system_name') }}</th>
                                        ...
                                        @if(isset($resultSystemList) && !$resultSystemList->isEmpty())
                                            ...
                                            @foreach($resultSystemList as $resultSystem)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary btn-xs mrg" data-original-title="{{ trans('translate.view') }}" data-toggle="tooltip" href="{{ route('result-system-view',[$resultSystem->id]) }}">
                                    ...
                                    <div class="pagination">{!!   str_replace('/?','?',$resultSystemList->render() ) !!} </div>
                                </div> <!-- box-body -->
                            </div> <!-- box -->
                        </div>
                    </div> <!-- row last -->
