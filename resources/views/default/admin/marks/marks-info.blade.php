                            ...
                            @if(isset($student) && !empty($student))
                               @if(isset($subjectData))
                                    @foreach($subjectData as $subject)
                                        <tr>
                                            <td>
                                                {{$subject->subject_name or 'Not Available'}}
                                            </td>
                                            <td>
                                                {{ $subject->subject_total_marks or 'Not Availalble' }}
                                            </td>
                                            @if(is_array($student->subjectMarks)
                                            && array_key_exists($subject->id,$student->subjectMarks))

                                                @set('stSubMarks',$student->subjectMarks[$subject->id])
                                            ...
                                            <td>
                                                ...
                                                @if(isset($studentMarks) && !$studentMarks->isEmpty())
                                                    ...
                                                    @if(in_array($subject->id,$subjectIds) )
                                                        ...
                                                        @set('subjectKey',array_search ($subject->id, $subjectIds))
                                            ...
                                            @if(isset($resultRule) && $resultRule=='grade')
                                                ...
                                                && !empty($subjectGrade)
                                                && array_key_exists($subject->id,$subjectGrade))

                                                    <td>{{ $subjectGrade[$subject->id][0] }} </td>
                                                    <td>{{ $subjectGrade[$subject->id][1] }} </td>
                                                @else
