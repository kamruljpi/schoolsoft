@inject('certificationForm','Erp\Forms\CertificationForm')
            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.get_certification') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.get_certification') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="custom_row">
                                         <h2 class="form_title">
                                            {{ trans('sidebar.get_certification') }}
                                        </h2>
                                    </div>                                   

                                    {!! formFields($certificationForm) !!}
                                    <div class="row custom_padding">
                                        {!! Form::submit('Certification',['class'=>'btn btn-primary','id'=>'certification-btn','readonly'=>'readonly']) !!}

                                    </div>
                                   </div>
                                </div><!-- /.box-body -->
                                 <div id="certification-report">
        ...
        $(document).ready(function(){
            ...
            $('#certification-btn').click(function () {
                ...
                if(studentClassId == 0 || sectionId == 0 || studentId == 0){
                    ...
                    $.ajax({
                        url: host + '/report/certification-report/' +studentClassId+'/'+ sectionId+'/'+studentId,
                        type: "GET", // not POST, laravel won't allow it
                        success: function(data){
                            /*alert(data);*/
                            $data = $(data); // the HTML content your controller has produced

                            $('#certification-report').html($data);
                        }
                    });
                }
