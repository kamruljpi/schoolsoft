            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.get_student_id_card') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.get_student_id_card') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body auto_scroll">
                                    ...
                                    <div class="custom_row">
                                         <h2 class="form_title">
                                            {{ trans('sidebar.get_student_id_card') }}
                                        </h2>
                                    </div>
