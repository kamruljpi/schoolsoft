@inject('TestimonialForm','Erp\Forms\TestimonialForm')
            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.get_testimonial') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.get_testimonial') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="box-body">
                                  <div class="print_none">
                                    ...
                                    <div class="custom_row">
                                             <h2 class="form_title">
                                                {{ trans('sidebar.get_testimonial') }}
                                            </h2>
                                        </div>

                                    {!! formFields($TestimonialForm) !!}
                                    <div class="row custom_padding">
                                        {!! Form::submit('Testimonial',['class'=>'btn btn-primary','id'=>'testimonial-btn','readonly'=>'readonly']) !!}
                                    </div>

                                 </div>  
                                </div><!-- /.box-body -->
                                 <div id="testimonial-report">
        ...
        $(document).ready(function(){
            ...
            $('#testimonial-btn').click(function () {
                ...
                if(studentClassId == 0 || sectionId == 0 || studentId == 0){
                    ...
                    $.ajax({
                        url: host + '/report/testimonial-report/' +studentClassId+'/'+ sectionId+'/'+studentId,
                        type: "GET", // not POST, laravel won't allow it
                        success: function(data){
                            /*alert(data);*/
                            $data = $(data); // the HTML content your controller has produced

                            $('#testimonial-report').html($data);
                        }
                    });
                }
