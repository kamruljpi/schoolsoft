@inject('clearanceForm','Erp\Forms\ClearanceForm')
            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.get_clearance') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.get_clearance') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="box-body">
                                    ...
                                    @endif
                                     ...
                                     <div class="custom_row">
                                         <h2 class="form_title">
                                            {{ trans('sidebar.get_clearance') }}
                                        </h2>
                                    </div>
                                    {!! formFields($clearanceForm) !!}
                                     <div class="row custom_padding">
                                        {!! Form::submit('Clearance',['class'=>'btn btn-primary','id'=>'clearance-btn','readonly'=>'readonly']) !!}
                                    </div>

                                    </div>
                                </div><!-- /.box-body -->
                                <div id="clearance-report">
        ...
        $(document).ready(function(){
            ...
            $('#clearance-btn').click(function () {
                ...
                if(studentClassId == 0 || sectionId == 0 || studentId == 0){
                    ...
                    $.ajax({
                        url: host + '/report/clearance-report/' +studentClassId+'/'+ sectionId+'/'+studentId,
                        type: "GET", // not POST, laravel won't allow it
                        success: function(data){
                            /*alert(data);*/
                            $data = $(data); // the HTML content your controller has produced

                            $('#clearance-report').html($data);
                        }
                    });
                }
