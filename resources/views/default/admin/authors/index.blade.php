            ...
            <div class="col-md-12">
                <div class="student-box-header">
                   <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.author_list') }}
                    </div>
                                ...
                                <div class="box-body auto_scroll">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">{{ trans('sidebar.author_name') }}</th>
                                            <th class="text-center">{{ trans('sidebar.date_of_birth') }}</th>
                                            <th class="text-center">{{ trans('sidebar.birth_place') }}</th>
                                    ...
                                    <div class="pagination">{!!   str_replace('/?','?',$authorList->render() ) !!} </div>
