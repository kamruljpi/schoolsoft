            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-12">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.create_teacher') }}
                    </div>
                    <div class="col-md-6 col-xs-12 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.create_teacher') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="inner-view">
            <div class="row">
                <div class="col-md-12 snt form-horizontal">
                    ...
                    <div class="custom_row">                      
                        <h2 class="form_title">
                            {{ trans('sidebar.teacher_enrole_form') }}
                        </h2>                                          
                    </div>
