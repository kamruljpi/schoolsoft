            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-6">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.edit_teacher') }}
                    </div>
                    <div class="col-md-6 col-xs-6 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.edit_teacher') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 snt form-horizontal">
                    ...
                    {!! Form::model(
                                $teacherProfile,
                                array(
                                'route' => ['teacher-edit',$teacherProfile->id],
                                'files' => true,
                                'id'=>'create-form',
                                'class'=>'form-create',
                                'method'=>'PATCH'
                    ...
                    {!! formFields($editTeacher,$mode='edit',$teacherProfile->id)  !!}
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var userId = "<?php echo $teacherProfile->id; ?> "
