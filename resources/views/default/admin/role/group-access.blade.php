...
<br>
 @if(isset($roleToAssign))
     <strong> {{ trans('sidebar.please_assign') }} <span style="color: blue;">{{ $roleToAssign->name }}</span></strong>
 @endif
<br><br>
                                  <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th> {{ trans('sidebar.menu') }}</th>
                                            <th style="text-align: center">{{ trans('sidebar.grant_access') }}</th>
                                           {{-- <th>Add</th>
                                            <th>Edit</th>
                                            <th>Delete</th>--}}
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td ><strong>{{ trans('sidebar.check_all') }}</strong></td>
