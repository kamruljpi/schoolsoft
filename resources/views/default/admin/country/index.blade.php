                ...
                <div class="student-box-header">
                    ...
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            <li>
                                <a href="{!! route('country-add-form') !!}"><i class="fa fa-plus"></i> {{ trans('sidebar_aziz.country-create') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($countryList as $country)
                                            ...
                                            <tr>
                                                <td>{{$sl++}}</td>
                                                <td>
                                                    {{ $country->translate($locale)? $country->country_name:$country->translate($defaultLocale)->country_name }}
                                                </td>
                                                <td>{{ $country->status or 'Null'}}</td>
                                                <td>
                                                    ...
                                                    <a  class="btn btn-danger btn-xs delete_btn mrg" data-original-title="{{ trans('translate.delete') }}" data-toggle="tooltip" href="{{ route('country-delete',[$country->id]) }}"><i class="fa fa-trash-o"></i></a>
                                                </td>
