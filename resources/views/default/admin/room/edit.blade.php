        ...
        <div class="row">
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.room_edit') }}
                    </div>
                    <div class="col-md-6 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.room_edit') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="inner-view">
            <div class="row">
                <div class="col-md-12 snt form-horizontal">
                    ...
                    {!! formFields($editRoom,$mode='edit',$roomData->id)  !!}
