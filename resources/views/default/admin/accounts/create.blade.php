            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.account_create') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.account_create') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="inner-box">
            <div class="row">
                <div class="col-md-12 snt form-horizontal">
                    ...
                    <div class="custom_row">                      
                        <h2 class="form_title">
                            {{ trans('sidebar.account_enrole_form') }}
                        </h2>                                          
                    </div>
