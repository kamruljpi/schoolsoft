@inject('createEmploymentHistoryForm','Erp\Forms\EmploymentHistoryForm')
            ...
            <div class="col-md-12">
                <div class="student-box-header">
                    <div class="col-md-6 col-xs-5">
                        <span class="glyphicon glyphicon-user " aria-hidden="true"></span>{{ trans('sidebar.employ_create') }}
                    </div>
                    <div class="col-md-6 col-xs-7 snt">
                        <ul class="breadcrumb text-right">
                            ...
                            <li class="active">{{ trans('sidebar.employ_create') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="inner-view">
            <div class="row">
                <div class="col-md-12 snt form-horizontal">
                    ...
                    {!! Form::open(array('route' => 'employment-history-create', 'files' => true, 'id'=>'create-form','class'=>'form-create')) !!}

                    {!! formFields($createEmploymentHistoryForm)  !!}
